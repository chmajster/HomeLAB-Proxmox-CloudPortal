...
final class PortalController
{
    ...
    public function page(Request $request): Response
    {
        ...
        $allowed = ['dashboard', 'vms', 'create-vm', 'projects', 'networks', 'templates', 'cloud-init', 'ssh-keys', 'activity', 'security', 'users', 'infrastructure', 'proxmox', 'storages', 'plans', 'quotas', 'audit', 'settings'];
