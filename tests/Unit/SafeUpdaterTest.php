...
final class SafeUpdaterTest extends TestCase
{
    ...
    public function testApplicationAndSchemaVersionsAdvanceTogetherWhenMigrationExists(): void
    {
        ...
        $migrationFile = dirname(__DIR__, 2) . '/database/migrations/1.8.0.sql';
        self::assertIsString($application);
        self::assertIsString($migration);
        self::assertFileExists($migrationFile);
        self::assertStringContainsString("public const VERSION = '1.8.0'", $application);
        self::assertStringContainsString("public const CURRENT_VERSION = '1.8.0'", $migration);
    }
}
