...
<?php if($me!==null): ?>
<?php $nav=[['Infrastruktura',[['dashboard','Dashboard','/',''],['providers','Połączenia','/infrastructure/providers','providers.read'],['credentials','Credentiale','/infrastructure/credentials','credentials.read'],['templates','Szablony','/infrastructure/templates','terraform.read'],['deployments','Deploymenty','/infrastructure/deployments','deployments.read'],['jobs','Zadania','/infrastructure/jobs','jobs.read'],['logs','Logi','/infrastructure/logs','jobs.read'],['ansible','Ansible','/infrastructure/ansible','ansible.read']]],['Administracja',[['users','Użytkownicy','/admin/users','users.read'],['roles','Role','/admin/roles','roles.read'],['permissions','Uprawnienia','/admin/permissions','roles.read'],['tokens','Tokeny API','/admin/tokens','tokens.read'],['audit','Audit','/admin/audit','audit.read']]],['Ustawienia',[['settings','Infrastruktura → Backend','/settings/infrastructure/backend','settings.update'],['account','Moje konto','/account','']]]]; ?>
